class Student:
    ...
    def rate_hw(self, lecturer, course, grade):
        """Выставляем оценки лектору студентом, если это лектор ведет лекции по данному курсу у этого студента
...
class Lecturer(Mentor):
    ...
    def __lt__(self, other):
        ...
        if not isinstance(other, Lecturer):
            print('Так сравненивать некорректно')
            return
        return self.average_rating < other.average_rating
...
class Reviewer(Mentor):
    def rate_hw(self, student, course, grade):
        """Выставления оценки студенту за домашние задания,

        На вход переменные rate_hw(self, student, course, grade)"""
    ...
    def __str__(self):
        """Средней оценка и возвращает характеристики экземпляра класса вида:
...
# Создаем лекторов и добавляем им курс
...
lecturer = [best_lecturer_1, best_lecturer_2, best_lecturer_3]
